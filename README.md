...
- `01_reasoning_controls_notebook.ipynb`: focused walkthrough for Nemotron reasoning controls, including `enable_thinking`, `reasoning_budget`, and `low_effort` comparisons.
- `02_simple_usage_notebook.ipynb`: end-to-end starter notebook covering basic chat completions, reasoning on/off, a LangChain v1.0 research assistant, and a multi-agent supervisor pattern.
